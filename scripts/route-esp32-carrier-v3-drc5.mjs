...
execFileSync(process.execPath,['scripts/route-esp32-carrier-v3-drc4.mjs'],{stdio:'inherit'});
...
r.push(
  seg(39.2,118.05,40,117,0.25,'F.Cu',55), via(40,117,55),
  seg(40,117,40,136,0.25,'B.Cu',55), via(40,136,55),
  seg(40,136,70,136,0.25,'F.Cu',55),
  seg(49,136,49,118,0.25,'F.Cu',55),
  via(70,136,55), seg(70,136,70,116,0.25,'B.Cu',55),
  seg(70,116,62.16,116,0.25,'B.Cu',55), seg(62.16,116,62.16,118,0.25,'B.Cu',55)
);

...
execFileSync(process.execPath, ["scripts/route-esp32-carrier-v3-drc2.mjs"], {
    stdio: "inherit",
});
...
r.push(
    ...
    seg(75.4, 121, 76.75, 123.1, 0.25, "F.Cu", 62),
);
...
r.push(
    ...
    seg(75.55, 123.75, 72.5, 123.75, 0.25, "F.Cu", 2),
    via(72.5, 123.75, 2),
...
r.push(
    seg(78.75, 122.55, 78.75, 120.5, 0.25, "F.Cu", 3),
    via(78.75, 120.5, 3),
    seg(77.75, 122.55, 77.75, 120.5, 0.25, "F.Cu", 3),
    via(77.75, 120.5, 3),
);

// U5 left/right ground pins fan outward to the bottom ground plane.
r.push(
    seg(75.55, 127.25, 74.0, 127.25, 0.25, "F.Cu", 3),
    via(74.0, 127.25, 3),
    seg(75.55, 127.75, 74.0, 128.0, 0.25, "F.Cu", 3),
    via(74.0, 128.0, 3),
    seg(75.55, 128.25, 74.0, 128.75, 0.25, "F.Cu", 3),
    via(74.0, 128.75, 3),

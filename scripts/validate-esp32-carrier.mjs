...
if (!text.startsWith("(kicad_pcb"))
    failures.push("fixture is not a KiCad PCB S-expression");
...
if (count(/\(property "Value" "20k"/g) < 9)
    failures.push("expected at least nine 20k divider resistors");
if (count(/\(property "Value" "2N7002"/g) < 4)
    failures.push("expected four 2N7002 brake/reverse MOSFETs");

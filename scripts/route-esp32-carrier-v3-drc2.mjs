...
r.push(
    ...
    via(38.4, 131.5, 59),
    seg(38.4, 131.5, 38.4, 119.35, 0.22, "B.Cu", 59),
    seg(38.4, 119.35, 32.4, 119.35, 0.22, "B.Cu", 59),
    via(32.4, 119.35, 59),
    seg(32.4, 119.35, 34.8, 119.35, 0.22, "F.Cu", 59),
    seg(29.1, 134, 29.1, 131.5, 0.22, "F.Cu", 58),
    via(29.1, 131.5, 58),
    seg(29.1, 131.5, 29.1, 120.65, 0.22, "B.Cu", 58),
    seg(29.1, 120.65, 32.4, 120.65, 0.22, "B.Cu", 58),
    via(32.4, 120.65, 58),
    seg(32.4, 120.65, 34.8, 120.65, 0.22, "F.Cu", 58),
);

// 65 SHDN has its own short B.Cu lane to R39.
r.push(
    seg(39.2, 121.95, 40.2, 122.8, 0.22, "F.Cu", 65),
    via(40.2, 122.8, 65),
...
r.push(
    seg(39.2, 118.05, 40.5, 116.5, 0.25, "F.Cu", 55),
    via(40.5, 116.5, 55),
...
r.push(
    seg(39.2, 119.35, 40.2, 120.0, 0.22, "F.Cu", 57),
    via(40.2, 120.0, 57),
    ...
    seg(73.8, 125.25, 75.55, 125.25, 0.35, "F.Cu", 57),
    seg(73.8, 125.75, 75.55, 125.75, 0.35, "F.Cu", 57),
    seg(73.8, 126.25, 75.55, 126.25, 0.35, "F.Cu", 57),
    via(70, 130, 57),
    ...
    seg(80.45, 125.25, 87, 125.25, 0.35, "F.Cu", 57),
    seg(80.45, 125.75, 87, 125.75, 0.35, "F.Cu", 57),
    seg(80.45, 126.25, 87, 126.25, 0.35, "F.Cu", 57),
...
r.push(
    seg(80.45, 123.75, 81.2, 122.7, 0.18, "F.Cu", 61),
...
r.push(
    seg(78.25, 122.55, 78.25, 119.5, 0.18, "F.Cu", 63),
    seg(78.25, 119.5, 78.9, 118, 0.18, "F.Cu", 63),
);
r.push(
    seg(78.75, 122.55, 79.7, 121.0, 0.22, "F.Cu", 3),
    via(79.7, 121.0, 3),
    seg(77.75, 122.55, 76.7, 121.0, 0.22, "F.Cu", 3),
    via(76.7, 121.0, 3),
...
r.push(
    ...
    via(75.0, 121.0, 62),
    seg(75.0, 121.0, 76.75, 122.55, 0.18, "F.Cu", 62),
...
r.push(
    ...
    seg(75.55, 123.75, 74.2, 122.7, 0.22, "F.Cu", 2),
    via(74.2, 122.7, 2),
...
r.push(
    seg(75.55, 127.25, 74.1, 127.25, 0.25, "F.Cu", 3),
    via(74.1, 127.25, 3),
    seg(75.55, 127.75, 74.1, 128.0, 0.25, "F.Cu", 3),
    via(74.1, 128.0, 3),
    seg(75.55, 128.25, 74.1, 128.75, 0.25, "F.Cu", 3),
    via(74.1, 128.75, 3),
    seg(80.45, 127.25, 82.5, 127.25, 0.25, "F.Cu", 3),
    via(82.5, 127.25, 3),
    seg(80.45, 127.75, 82.5, 128.0, 0.25, "F.Cu", 3),
    via(82.5, 128.0, 3),
    seg(80.45, 128.25, 82.5, 128.75, 0.25, "F.Cu", 3),
    via(82.5, 128.75, 3),
    via(77.3, 124.25, 3, 0.8, 0.4),
    via(78.7, 124.25, 3, 0.8, 0.4),
    via(77.3, 126, 3, 0.8, 0.4),
    via(78.7, 126, 3, 0.8, 0.4),
    via(77.3, 127.75, 3, 0.8, 0.4),
    via(78.7, 127.75, 3, 0.8, 0.4),
);
...
for (const x of [77.25, 77.75, 78.25, 78.75, 79.25])
    r.push(seg(x, 129.45, x, 131.2, 0.18, "F.Cu", 66));
r.push(
...
r.push(
    seg(29.5, 126, 31.0, 126, 0.35, "F.Cu", 3),
    via(31.0, 126, 3),
    seg(26.4, 134, 25.0, 134, 0.25, "F.Cu", 3),
    via(25.0, 134, 3),
    seg(34.8, 121.95, 33.5, 123.0, 0.25, "F.Cu", 3),
    via(33.5, 123.0, 3),
);

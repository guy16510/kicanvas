...
r.push(
    ...
    via(41.5, 119.35, 57),
    seg(41.5, 119.35, 41.5, 145, 0.25, "B.Cu", 57),
...
r.push(
    ...
    seg(74.2, 125.25, 75.55, 125.25, 0.3, "F.Cu", 57),
    seg(74.2, 125.75, 75.55, 125.75, 0.3, "F.Cu", 57),
    seg(74.2, 126.25, 75.55, 126.25, 0.3, "F.Cu", 57),
);
...
r.push(
    ...
    seg(88.9, 126, 83, 126, 0.35, "F.Cu", 57),
    seg(84.6, 124.25, 84.6, 126, 0.3, "F.Cu", 57),
    seg(83, 125.25, 83, 126.25, 0.3, "F.Cu", 57),
    seg(80.45, 125.25, 83, 125.25, 0.3, "F.Cu", 57),
    seg(80.45, 125.75, 83, 125.75, 0.3, "F.Cu", 57),
    seg(80.45, 126.25, 83, 126.25, 0.3, "F.Cu", 57),
);
...
r.push(
    seg(75.55, 123.75, 74, 123.75, 0.25, "F.Cu", 2),
    via(74, 123.75, 2),
...
r.push(
    seg(78.75, 122.55, 78.75, 121.4, 0.25, "F.Cu", 3),
    seg(78.75, 121.4, 79.8, 121.4, 0.25, "F.Cu", 3),
    seg(79.8, 121.4, 79.8, 120.3, 0.25, "F.Cu", 3),
    via(79.8, 120.3, 3),
    seg(77.75, 122.55, 77.75, 121.4, 0.25, "F.Cu", 3),
...
r.push(
    seg(75.55, 127.25, 74, 127.25, 0.25, "F.Cu", 3),
    via(74, 127.25, 3),
    seg(75.55, 127.75, 74, 128, 0.25, "F.Cu", 3),
    via(74, 128, 3),
    seg(75.55, 128.25, 74, 128.75, 0.25, "F.Cu", 3),
    via(74, 128.75, 3),
    seg(80.45, 127.25, 82.5, 127.25, 0.25, "F.Cu", 3),
    via(82.5, 127.25, 3),
    seg(80.45, 127.75, 82.5, 128, 0.25, "F.Cu", 3),
    via(82.5, 128, 3),
...
r.push(
    ...
    via(82.2, 118, 3),
    seg(29.5, 126, 31, 126, 0.35, "F.Cu", 3),
    via(31, 126, 3),
    seg(26.9, 134, 25.5, 134, 0.25, "F.Cu", 3),
    via(25.5, 134, 3),
    seg(34.8, 121.95, 33.5, 123, 0.25, "F.Cu", 3),
    via(33.5, 123, 3),
